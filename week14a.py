...
# We can make a hostogram with bars color coded to indicate the values
...
plt.boxplot(cars['Length'], notch=None, sym='')
plt.show()

# We can change outlier point symbols
plt.boxplot(cars['Length'], notch=None, sym='rs') # 'rs' = red square
plt.show()

# We can have horizontal boxes
plt.boxplot(cars['Length'], notch=None, sym='rs', vert=False) 
plt.show()
...
plt.boxplot(cars['Length'], notch=None, sym='rs', vert=False, whis=0.75) 
