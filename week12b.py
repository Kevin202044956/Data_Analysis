...
## Topic: Dictionaries and Tweets (Part 1)
##
...
# keys point to can be any Python type (string, number, list, Series, ...).
# The keys and values are separated by ":", the key-value pairs by commas,
# and the entire dictionary is delimited by "{}".  
dict1 = {'item1': 'Dog',
         'number2': 273,
         'three': ['S','T','A','T'],
...
# We can also remove a key-value pair
del dict1['number2']
dict1
...
# Sometimes dictionary values are also dictionaries.
dict2 = {'time': '09:30',
         'dept': 'STAT',
...
## Tweets
#
# When we retrieve tweets from Twitter, they will be sent to us in JSON
# format, which closely resembles how we define a dictionary.  Below is
# an example that has been converted and formatted to make it a more readable. 
...
tweet['entities']['user_mentions'][3]['name']  
...
# change these to Python-friendly "False", "True", and "None".
...
for tweet in tweetlist:
    print(tweet['id'])  # Print out the ID number of tweeter
