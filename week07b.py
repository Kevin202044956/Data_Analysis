...
# good choice as it does not add in line break.  
...
# We have the opportunity to use vectorizable string
...
schools.value_counts()  # The number of times each school appears
...
problems = newlines.str.split().str[8].str.split('/').str[-1]
print(problems)

print(np.unique(problems)) # The unique problem names
print(problems.value_counts()) # Counts for each problem
