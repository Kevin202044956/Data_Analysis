##
## File: week13b.py (STAT 3250)
## Topic: Graphics (Part 1)
##
...
plt.xlabel('Weight (lbs)')
plt.ylabel('Engine Displacement (in^3)')
plt.scatter(x, y, marker = '^', s = area, c = color)
plt.show()
...
# 9which is done above) and the color vector.  The color vector is already
...
# We change the color of the rectangles, and 
